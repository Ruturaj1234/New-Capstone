      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="p-4 lg:p-8 max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition">
              <h3 className="text-gray-500 text-sm font-medium">Active Clerks</h3>
              <p className="text-2xl lg:text-3xl font-bold text-gray-900 mt-1">
                {users.clerks.length}
              </p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="mt-1 p-2 lg:p-3 border border-gray-300 rounded-md w-full"
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="mt-1 p-2 lg:p-3 border border-gray-300 rounded-md w-full pr-10"
                    />
                    <button
                      type="button"
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-orange-600 text-white py-2 lg:py-3 rounded-lg hover:bg-orange-700"
                  >
                    {isLoading
                      ? "Saving..."
                      : editingUser
